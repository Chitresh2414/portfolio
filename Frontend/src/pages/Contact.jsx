...
const Contact = () => {
  ...
  // Social Data
  const socials = [
    { name: "LinkedIn", url: "https://linkedin.com/in/chitresh-sen-bca", color: "#0077B5" },
    { name: "GitHub", url: "https://github.com/chitresh2414", color: "#6e5494" },
    { name: "Instagram", url: "https://instagram.com/heyitschinku", color: "#E4405F" },
  ];
  ...
  return (
    <section ref={container} className="relative min-h-screen bg-[#030303] text-white py-24 px-6 flex items-center overflow-hidden">
      
      {/* Background Orbs (Cinematic Lighting) */}
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="mb-24">
          <div className="contact-reveal flex items-center gap-3 mb-6">
            ...
            <span className="font-mono text-[10px] tracking-[0.6em] uppercase text-amber-500/80">Available for projects</span>
          </div>
        ...
        <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-20 items-start">
          ...
          {/* LEFT: The Minimalist Form */}
          <form ref={formRef} className="space-y-12">
            {[
              { id: "name", label: "Full Name", type: "text" },
              { id: "email", label: "Email Address", type: "email" },
              { id: "msg", label: "Your Message", type: "textarea" }
            ].map((field) => (
              <div key={field.id} className="contact-reveal relative group">
                ...
                <label className="absolute left-0 top-4 text-white/20 pointer-events-none transition-all duration-500 
            ...
            <div className="contact-reveal pt-10">
              <button className="magnetic-btn group relative px-14 py-6 bg-white text-black rounded-full font-bold overflow-hidden transition-transform duration-300">
                <span className="relative z-10 tracking-widest text-xs">DISPATCH MESSAGE</span>
          ...
          <div className="space-y-8">
            <div className="contact-glass-card p-12 rounded-[2.5rem] bg-white/2 border border-white/10 backdrop-blur-3xl relative overflow-hidden group">
              ...
              <h4 className="text-white/30 font-mono text-[10px] tracking-[0.4em] uppercase mb-12">Contact Data</h4>
              
              <div className="space-y-12">
                <div>
                  <p className="text-amber-500 text-[10px] uppercase tracking-widest mb-3 font-bold">Location</p>
                  <p className="text-2xl font-light text-white/80">Udaipur, Rajasthan, India</p>
                </div>

                <div>
                  <p className="text-amber-500 text-[10px] uppercase tracking-widest mb-3 font-bold">Inquiries</p>
                ...
                <div>
                  <p className="text-amber-500 text-[10px] uppercase tracking-widest mb-6 font-bold">Social Echo</p>
